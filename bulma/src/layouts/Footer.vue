  ...
  <div class="container">
    <div class="columns is-multiline is-align-items-center border-bottom py-5">
      <div class="column is-4-desktop is-12-tablet">
        <ul
          class="list-inline footer-menu has-text-centered has-text-left-desktop"
        >
      ...
      <div class="column is-4-desktop is-12-tablet">
        <ul
          class="list-inline social-icons has-text-right-desktop has-text-centered"
        >
          <li class="list-inline-item">
    ...
    <div class="py-4 has-text-centered">
      <small class="text-light"
        ...
        <a href="https://themefisher.com">themefisher</a></small
      >
    </div>
  </div>
</template>