<template>
  ...
  <p>
    ...
    markdownify rules. For example: use <code>#</code> for heading 1 and use
    <code>######</code> for heading 6.
  </p>
  ...
  <p>
    ...
    <a href="http://www.example.com">http://www.example.com</a> and sometimes
  ...
  <p>
    ...
    maxime corporis cumque totam aliquid nam sint inventore optio modi neque
    laborum officiis necessitatibus, facilis placeat pariatur! Voluptatem, sed
    harum pariatur adipisci voluptates voluptatum cumque, porro sint minima
    similique magni perferendis fuga! Optio vel ipsum excepturi tempore
    reiciendis id quidem? Vel in, doloribus debitis nesciunt fugit sequi magnam
    accusantium modi neque quis, vitae velit, pariatur harum autem a! Velit
    impedit atque maiores animi possimus asperiores natus repellendus excepturi
    sint architecto eligendi non, omnis nihil. Facilis, doloremque illum. Fugit
    optio laborum minus debitis natus illo perspiciatis corporis voluptatum
    rerum laboriosam.
  </p>
  ...
  <div class="border border-default collapse-wrapper">
    <a
      class="is-flex is-align-items-center p-2 collapse-head"
      data-toggle="collapse"
      href="#collapse-1"
      role="button"
      >collapse 1 <i class="ti-plus ml-auto no-pointer"></i
    ></a>
  ...
  <div class="border border-default collapse-wrapper">
    <a
      ...
      href="#collapse-2"
      role="button"
      >collapse 2 <i class="ti-plus ml-auto no-pointer"></i
    ></a>
  ...
  <div class="border border-default collapse-wrapper">
    <a
      ...
      href="#collapse-3"
      role="button"
      >collapse 3 <i class="ti-plus ml-auto no-pointer"></i
    ></a>
  ...
  <p>
    You can also use raw HTML in your Markdown, and it&rsquo;ll mostly work
    pretty well.
  </p>
  <dl>
  ...
  <p>
    ...
    (|) are optional, and you don&rsquo;t need to make the raw Markdown line up
